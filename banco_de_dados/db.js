...
// O método 'verbose()' ativa mensagens extras no console para facilitar o debug (mensagens de erro mais detalhadas)
...
// Isso evita conflitos ou problemas de concorrência, que podem acontecer quando várias operações tentam acessar o banco ao mesmo tempo
banco.serialize(() => {
...
// Exporta a variável 'banco' para que outras partes do projeto (como as rotas) possam acessar o banco de dados
